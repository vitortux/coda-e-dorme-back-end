...
import br.com.codaedorme.pi.domain.produto.ProdutoService;
...
public class ProdutoController {
	...
	public ResponseEntity<Produto> getProdutoById(@PathVariable Long id) {
		// Procura o produto no banco de dados usando o ID
		...
		// Se o produto for encontrado, retorna ele com status 200
